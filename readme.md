...
1. Расчёт потенциалов через заземление V_d.
2. Расчёт сопротивление R1 через потенциалы и сопротивления других источников (по уравнению 4.8)
3. Расчёт потенциалов узлов V_a = V_c, V_b.
4. Расчёт сил тока в каждой из ветвей, где ток есть. (т.е. кроме цепи CA или CGA)
5. Расчёт напряжений в ветвях без источников энергии (AB, DA, CD)
...
- По желанию можно ознакомиться с переменными, которые использовались при вычислении, нажав на Чекбокс "Показать пеерменные, используемые при счёте"
